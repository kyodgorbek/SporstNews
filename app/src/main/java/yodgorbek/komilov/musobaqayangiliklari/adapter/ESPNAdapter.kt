...
import yodgorbek.komilov.musobaqayangiliklari.databinding.EspnListBinding
...
class ESPNAdapter(
    ...
    lateinit var binding: EspnListBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            MyViewHolder {
        binding = EspnListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
